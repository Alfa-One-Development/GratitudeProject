...
server: 'localhost',  // Nome do servidor (pode ser 'localhost' ou um endereço remoto) 
    ...
    authentication: { 
        ...
        options: { 
            userName: 'ProjetoGratitude',    // Nome do usuário do banco de dados 
            password: 'Gratitude1234'  // Senha do banco de dados 
        } 
    }, 
    options: { 
        database: 'DesafioGratitude',      // Nome do banco de dados 
